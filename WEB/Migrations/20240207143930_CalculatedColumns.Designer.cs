...
namespace Monic.Web.Migrations
{
    ...
    [Migration("20240207143930_CalculatedColumns")]
    partial class CalculatedColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Monic.Web.Models.Document", b =>
                {
                    b.HasOne("Monic.Web.Models.DocumentContent", "DocumentContent")
                        .WithOne("Document")
                        .HasForeignKey("Monic.Web.Models.Document", "DocumentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
