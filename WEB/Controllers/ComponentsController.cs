...
namespace Monic.Web.Controllers
{
    ...
    {
        public ComponentsController(IDbContextFactory<ApplicationDbContext> dbFactory, UserManager<User> um, AppSettings appSettings)
        ...
        public async Task<IActionResult> Save(Guid componentId, [FromBody] ComponentDTO componentDTO)
        {
            ...
            await ItemFunctions.HydrateFieldsAsync(db, component.ComponentId, componentDTO.ItemFields, componentDTO.ItemOptions);
