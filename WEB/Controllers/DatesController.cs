...
namespace WEB.Controllers
{
    ...
    {
        public DatesController(ApplicationDbContext db, UserManager<User> um, AppSettings appSettings) : base(db, um, appSettings) { }
        ...
        public async Task<IActionResult> Delete(Guid dateId)
        {
            ...
            if (await db.Dates.AnyAsync(o => o.QuarterId == date.DateId))
                return BadRequest("Unable to delete the date as it has related dates");
