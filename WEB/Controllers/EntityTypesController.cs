...
namespace WEB.Controllers
{
    ...
    {
        public EntityTypesController(ApplicationDbContext db, UserManager<User> um, AppSettings appSettings) : base(db, um, appSettings) { }
        ...
        {
            foreach (var questionnaire in db.Questionnaires.Where(o => o.EntityTypeId == entityTypeId).ToList())
