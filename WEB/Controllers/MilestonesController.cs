...
namespace WEB.Controllers
{
    ...
    {
        public MilestonesController(ApplicationDbContext db, UserManager<User> um, AppSettings appSettings) : base(db, um, appSettings) { }
        ...
        public async Task<IActionResult> Delete(Guid milestoneId)
        {
            ...
            foreach (var task in db.Tasks.Where(o => o.MilestoneId == milestone.MilestoneId))
