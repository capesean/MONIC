...
export class ProjectEditComponent implements OnInit, OnDestroy {
    ...
    deleteMilestones(): void {
        let modalRef = this.modalService.open(ConfirmModalComponent, { centered: true });
        (modalRef.componentInstance as ConfirmModalComponent).options = { title: "Delete Milestones", text: "Are you sure you want to delete all the milestones?", deleteStyle: true, ok: "Delete" } as ConfirmModalOptions;
        modalRef.result.then(
            () => {
