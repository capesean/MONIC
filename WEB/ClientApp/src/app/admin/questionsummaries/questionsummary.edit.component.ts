...
export class QuestionSummaryEditComponent implements OnInit {
    ...
    delete(): void {
        ...
        (modalRef.componentInstance as ConfirmModalComponent).options = { title: "Delete Question Summary", text: "Are you sure you want to delete this question summary?", deleteStyle: true, ok: "Delete" } as ModalOptions;
