...
export class DatumEditComponent implements OnInit {
    ...
    delete(): void {
        ...
        (modalRef.componentInstance as ConfirmModalComponent).options = { title: "Delete Datum", text: "Are you sure you want to delete this datum?", deleteStyle: true, ok: "Delete" } as ConfirmModalOptions;
