...
import { IndicatorPermission } from '../models/indicatorpermission.model';
...
export class UserService extends SearchQuery {
    ...
    saveEntityPermissions(id: string, entityIds: string[]): Observable<void> {
        return this.http.post<void>(`${environment.baseApiUrl}users/${id}/entitypermissions`, entityIds);
    }

    deleteEntityPermissions(id: string): Observable<void> {
        return this.http.delete<void>(`${environment.baseApiUrl}users/${id}/entitypermissions`);
    }

    deleteIndicatorPermissions(id: string): Observable<void> {
        return this.http.delete<void>(`${environment.baseApiUrl}users/${id}/indicatorpermissions`);
    }

    addIndicatorPermissions(id: string, indicatorPermissions: IndicatorPermission[]): Observable<void> {
        return this.http.post<void>(`${environment.baseApiUrl}users/${id}/indicatorpermissions`, indicatorPermissions);
    }
