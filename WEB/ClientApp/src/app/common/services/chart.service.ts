...
export class ChartService extends SearchQuery {
    ...
    getData(indicatorIds: string[], entityIds: string[] = []): Observable<ChartData> {
        return this.http.post<ChartData>(`${environment.baseApiUrl}charts/data`, { indicatorIds, entityIds });
    }
